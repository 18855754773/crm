...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        //通过线索的id获取线索对象（线索对象中封装的信息）
        Clue c = clueDao.getById(clueId);

        //通过线索对象提取客户信息，当客户不存在时，新建客户（根据公司的名称精确匹配，判断该客户是否存在）
        ...
        for (ClueActivityRelation clueActivityRelation : clueActivityRelationList){
            ...
            if (count5 != 1){
                ...
                flag = false;
                System.out.println("--------->创建联系人与市场活动的关联关系对象失败");
        ...
        if (t != null){
            ...
            //可以通过第一步生成的c对象 取出一些信息 继续完善对t对象的封装
       ...
       for (ClueActivityRelation clueActivityRelation : clueActivityRelationList){
            ...
            if (count9 != 1){
                ...
                flag = false;
                System.out.println("--------->删除线和市场活动关系失败");
