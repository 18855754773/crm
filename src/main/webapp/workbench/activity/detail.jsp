            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    if (data.success){
                        ...
                        //修改备注成功之后
                        // 更新div中的相应的信息，需要更新的内容有 noteContent editTime editBy
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data, function (i,n) {
					...
					html += 'ont color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;"> '+ (n.editFlag==0?n.createTime:n.editTime) +' 由'+ (n.editFlag==0?n.createBy:n.editBy) +'</small>';
					html += 'iv style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
					html += ' class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>';
					html += 'bsp;&nbsp;&nbsp;&nbsp;';
					html += ' class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>';
					html += 'div>';
					html += 'div>';
					html += 'div>';*/
