	...
	<script>
		...
		$(function () {
			...
			$("#create-stage").change(function () {
				...
				/*stage是一个变量，不能用传统的json.key的形式来取值   要使用下面的方式*/
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="26cb40471a5a45cdbbec279be3796c3a"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="02ff621dd93943f6adf77957e16dd9d2"/>
			</div>
		</div>
